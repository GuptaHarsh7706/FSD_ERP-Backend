...
public interface EnrollmentRepository extends JpaRepository<Enrollment, Long> {
    ...
    @Query("SELECT e FROM Enrollment e WHERE e.student.id = :studentId AND e.subject.id = :subjectId AND e.academicYear = :academicYear AND e.semester = :semester")
    List<Enrollment> findByStudentIdAndSubjectIdAndAcademicYearAndSemester(
